...
/**
 * This class is used to retrieve places that match the user's search query near their
 * GPS location via an asynchronous task using the Google Places API
 */


public class SearchNearbyRestaurantsTask extends AsyncTask<String, Void, ArrayList<String>> {
    // Used for logging purposes
    private final String LOG_TAG = SearchNearbyRestaurantsTask.class.getSimpleName();
    ...
    /**
     * Take the string representing all the restaurants that match the search query in JSON Format and
    ...
    /**
     *
     * @param params are the latitude, longitude, and search query strings. The method expects it to come in the format
     *               params[latitude, longitude, query]
     * @return ArrayList of parsed JSON strings
